...
export default function App() {
  const [summonIncomplete, setSummonIncomplete] = useState(true);
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <Dashboard
                db={supabase}
                summonIncomplete={summonIncomplete}
                setSummonIncomplete={setSummonIncomplete}
              />
            }
          />
          ...
          <Route
            path="/boondoggleai"
            element={
              <BoondogggleAI db={supabase} showOnboarding={summonIncomplete} />
            }
          />
