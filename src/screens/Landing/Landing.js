    ...
    <div className="landing-container">
      ...
      <div className="landing-text-container">
        ...
        <p className="landing-text-medium">
          Boondoggle <span style={{ fontWeight: "700" }}>summarizes</span> your
          social media messages, emails, <br /> and meeting notes,{" "}
        ...
        <p className="landing-text-medium">
          ...
          <span style={{ fontWeight: "700" }}>50+ common workplace</span> tool
          integrations, powering our{" "}
            ...
            <>
              ...
              <div className="integration-table-cell">
                <img
                  ...
                  className="integration-table-img"
                ></img>
                <p className="integration-table-cell-label">Google Workspace</p>
              </div>
            </>
          )}
          {category == "meeting" && (
        ...
        <div className="upper-footer-container">
          ...
          <div className="upper-footer-pages">
            ...
            <div className="upper-footer-column">
              ...
              <span className="upper-footer-column-text">Privacy Policy</span>
              <span className="upper-footer-column-text">Terms of Service</span>
            </div>
          </div>
        </div>
